          ...
          <div class="card card-details">
            ...
            <div class="attendee">
              <table class="table table-responsive-sm text-center">
                ...
                <tbody>
                  <tr>
                    <td><img src="{{ url('frontend/images/avatar1.png') }}" height="60"></td>
                    <td class="align-middle">Steward</td>
                  ...
                  <tr>
                    <td><img src="{{ url('frontend/images/avatar2.png') }}" height="60"></td>
                    <td class="align-middle">Roxy</td>
            ...
            <div class="member mt-3">
              ...
              <p class="disclaimer mb-0">
                You are only  able to invite member that has registerd in Nomads
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="card card-details card-right">
            ...
            <table class="trip-informations">
              ...
              <tr>
                ...
                <th width="50%" class="text-right text-total">
