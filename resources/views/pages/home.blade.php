      ...
      <div class="section-popular-travel row justify-content-center">
        @foreach($items as $item)
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="card-travel text-center d-flex flex-column" style="background-image: url('{{ $item->galleries->count() > 0 ? Storage::url($item->galleries->first()->image) : '' }}');">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-8 text-center">
          <img src="{{ url('frontend/images/partner-logo.png') }}" alt="Logo Partners" class="img-partner">
        </div>
      </div>
    </div>
  </section>
